...
if (updateDataForm) updateDataForm.addEventListener("submit", (e)=>{
    ...
    (0, _updatSettings.updateData)(form);
});
if (updatePasswordForm) updatePasswordForm.addEventListener("submit", (e)=>{
    ...
    (0, _updatSettings.updatePassword)(currentPassword, newPassword, passwordConfirm);
    document.querySelector(".btn--password-save").textContent = "SAVE PASSWORD";
});

},{"@babel/polyfill":"dTCHC","./login":"7yHem","./mapbox":"3zDlz","./updatSettings":"i0IrA"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoicGFydGgwNjAyIiwiYSI6ImNseHJxNTUzYzE5Y2kycnFydjRvZjhocnMifQ.vPHpvDHHkzjJaIjHlBL9tw";
    var map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/parth0602/clxruo4po003401pfgrlk3h6r",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i0IrA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateData = async (data)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Update in Successfully");
            window.setTimeout(()=>{
                location.assign("/me");
            }, 1500);
        }
...
const updatePassword = async (currentPassword, newPassword, passwordConfirm)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Password is updated in Successfully");
            window.setTimeout(()=>{
                location.assign("/me");
            }, 1500);
        }
